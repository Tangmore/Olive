            ...
            <div class="row " > 
                     <div class="col-md-2 col-sm-12"> 
                        <a class="col align-self-center text-center" href="#">
                            <img id="brand" :src="this.$store.state.imgUrl+'/img/logo/lemon_logo_white.png'" >
                        </a>
                    </div> 
                    <div  class="col-md-7 col-sm-12 text_small text-center ml-4">
                                <p> © 2018 Olive.cn 渝ICP备1343111号 </p> 
                                <p>举报邮箱 OLive@olive.com
                                &nbsp;olive客服：国内8888-125-345
                           </p>    
                    </div>
                </div>
